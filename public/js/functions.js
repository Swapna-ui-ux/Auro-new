...
! function(e) {
    ...
    SEMICOLON.initialize = {
        ...
        menufunctions: function() {
            ...
            l = Number(l), i = n.children(".sub-menu-trigger"), o.hasClass("device-xl") || o.hasClass("device-lg") ? (setTimeout(function() {
                y.length > 0 && y.css({
                ...
                let n = e(this);
                n.parents(".sub-menu").siblings().find(a).stop(!0, !0).slideUp(l), n.parent(".menu-item").children(s).stop(!0, !0).slideToggle(l), i.preventDefault()
            }) : o.hasClass("side-header") && M.hasClass("on-click") || o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs") ? (i.removeClass("icon-rotate-90"), e(".menu-item").find(a).filter(":not(:animated)").stop(!0, !0).slideUp(l, function() {
                o.toggleClass("primary-menu-open", !1)
            }), (i = i.add(t.filter('[href^="#"]'))).off("click").on("click", function(i) {
                let n = e(this);
                n.parents(".sub-menu").siblings().find(".sub-menu-trigger").removeClass("icon-rotate-90"), n.parents(".sub-menu").siblings().find(a).filter(":not(:animated)").stop(!0, !0).slideUp(l), n.parent(".menu-item").children(s).filter(":not(:animated)").stop(!0, !0).slideToggle(l);
            ...
            })) : (o.hasClass("overlay-menu") || o.hasClass("side-header")) && (o.hasClass("device-xl") || o.hasClass("device-lg")) ? (M.find(a).stop(!0, !0).slideUp(l), e(".menu-item").hover(function(i) {
                e(this).children(s).stop(!0, !0).slideDown(l)
            }, function() {
                e(this).children(s).stop(!0, !0).slideUp(l)
            })) : M.hasClass("on-click") && t.off("click").on("click", function(i) {
                let n = e(this);
                n.parents(".sub-menu").siblings().find(a).removeClass("d-block"), n.parent(".menu-item").children(s).toggleClass("d-block"), i.preventDefault()
                ...
                return (o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs")) && (M.find(".mobile-primary-menu").length > 0 ? (e(".primary-menu:not(.mobile-menu-off-canvas) .mobile-primary-menu").stop(!0, !0).slideToggle(l), e(".primary-menu.mobile-menu-off-canvas .mobile-primary-menu").toggleClass("d-block")) : (e(".primary-menu:not(.mobile-menu-off-canvas) .menu-container").stop(!0, !0).slideToggle(l), e(".primary-menu.mobile-menu-off-canvas .menu-container").toggleClass("d-block"))), o.toggleClass("primary-menu-open"), !1
        ...
        removeStickyness: function() {
            d.hasClass("sticky-header") && (d.removeClass("sticky-header"), d.removeClass().addClass(L), u.removeClass().addClass(v), u.hasClass("force-not-dark") || u.removeClass("not-dark"), SEMICOLON.slider.swiperSliderMenu(), SEMICOLON.slider.revolutionSliderMenu(), y.length > 0 && u.outerHeight() > y.outerHeight() && y.css({
                height: u.outerHeight()
            })), (o.hasClass("device-sm") || o.hasClass("device-xs") || o.hasClass("device-md")) && void 0 === k && (d.removeClass().addClass(L), u.removeClass().addClass(v), u.hasClass("force-not-dark") || u.removeClass("not-dark"))
        },
        sideHeader: function() {
        ...
        miscFunctions: function() {
            ...
            e(document).on("click", function(t) {
                e(t.target).closest(".top-search-form").length || (o.toggleClass("top-search-open", !1), n = setTimeout(function() {
                    i.toggleClass("position-relative", !1)
                }, 750)), e(t.target).closest("#top-cart").length || G.toggleClass("top-cart-open", !1), e(t.target).closest("#page-menu").length || $.toggleClass("page-menu-open", !1), e(t.target).closest("#side-panel").length || o.toggleClass("side-panel-open", !1), e(t.target).closest(".primary-menu.on-click").length || M.filter(".on-click").find(".menu-container").find(".d-block").removeClass("d-block"), M.hasClass("mobile-menu-off-canvas") && (e(t.target).closest(".primary-menu.mobile-menu-off-canvas .menu-container").length || (M.filter(".mobile-menu-off-canvas").find(".menu-container").toggleClass("d-block", !1), o.toggleClass("primary-menu-open", !1))), e(t.target).closest(".top-links.on-click").length || e(".top-links.on-click").find(".top-links-sub-menu,.top-links-section").removeClass("d-block")
            })
        }
    }, SEMICOLON.slider = {
        init: function() {
        ...
        init: function() {
            ...
            let i = location.hash;
            e(i).length > 0 && e(".one-page-menu").find('[data-href="' + i + '"]').length > 0 && l.scrollTop(0)
        },
    ...
    let i, n, t, s, a, l = e(window),
        ...
        L = d.attr("class"),
        v = u.attr("class"),
        w = d.attr("data-sticky-class"),
        k = d.attr("data-responsive-class"),
        x = e("#logo"),
