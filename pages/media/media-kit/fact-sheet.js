					...
					<div className="row col-mb-50">
						<div className="col-12">
							<div className="head-title">
								...
								<p>Aurobindo also develops fermentation based semi synthetic products and produces novel proprietary biocatalysts through its subsidiary AuroZymes. AuroZymes has developed key core technology in biocatalysis and has identified a number of products for implementation within the Aurobindo group of companies. Its technology development includes panels of 12-different classes’ enzymes and approximately 3,000 biocatalysts for use in screening against potential targets.
									<br/>Recently, Aurobindo entered Poland and the Czech Republic with the acquisition of commercial operations from Apotex. The company also strengthened its US presence with acquisition of dermatology and oral solid businesses from Sandoz.</p>
...
Factsheet.propTypes = propTypes;
Factsheet.defaultProps = defaultProps;
// #endregion
